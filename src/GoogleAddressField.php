...
class GoogleAddressField extends TextField
{
    ...
    public function Field($properties = [])
    {
        ...
        $this->setAttribute('data-relatedFields', Convert::raw2att(json_encode($this->getFieldMap())));
        ...
        $this->setAttribute('data-defaultAddress', Convert::raw2att(str_replace("'", '', (string) $this->getValue())));
        //right title
        $this->RightTitle();
